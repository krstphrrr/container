...
function likable_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state) {
  ...
  $form['likable_settings']['slideshow']['slide4'] = array(
    '#type' => 'fieldset',
    '#title' => t('Slide 4'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['likable_settings']['slideshow']['slide4']['slide4_head'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Headline'),
    '#default_value' => theme_get_setting('slide4_head','likable'),
  );
  $form['likable_settings']['slideshow']['slide4']['slide4_desc'] = array(
    '#type' => 'textarea',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide4_desc','likable'),
  );
  $form['likable_settings']['slideshow']['slide4']['slide4_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide4_url','likable'),
  );
  $form['likable_settings']['slideshow']['slide4']['slide4_image'] = array(
    '#type' => 'managed_file',
    '#title' => t('Image 4'),
    '#default_value' => theme_get_setting('slide4_image','likable'),
    '#upload_location' => 'public://',
  );
  $form['likable_settings']['slideshow']['slide5'] = array(
    '#type' => 'fieldset',
    '#title' => t('Slide 5'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['likable_settings']['slideshow']['slide5']['slide5_head'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Headline'),
    '#default_value' => theme_get_setting('slide5_head','likable'),
  );
  $form['likable_settings']['slideshow']['slide5']['slide5_desc'] = array(
    '#type' => 'textarea',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide5_desc','likable'),
  );
  $form['likable_settings']['slideshow']['slide5']['slide5_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide5_url','likable'),
  );
  $form['likable_settings']['slideshow']['slide5']['slide5_image'] = array(
    '#type' => 'managed_file',
    '#title' => t('Image 5'),
    '#default_value' => theme_get_setting('slide5_image','likable'),
    '#upload_location' => 'public://',
  );
